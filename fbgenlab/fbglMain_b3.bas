      ...
      screenSet 0, 1
         ...
         if adnShowUp then ''******************************************************
            ...
            for i as integer = 0 to TT2._maxDots - 1
               ...
               relative3DPosition(i)._z = (relative3DPosition(i)._z - sp3D._z)/w + sp3D._z + adnMakeUpParam              
            ...
            for i as integer = 0 to TT2._maxDots - 1
               ...
               relative3DPosition_2(i)._z = (relative3DPosition_2(i)._z - sp3D_2._z)/w + sp3D_2._z + adnMakeUpParam
               'convert 3d to 2d coordinates
