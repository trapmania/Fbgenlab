...
dodicatfontmanagement:
        ...
        For y As Long=0 To (_y)-1 : For x As Long=0 To (_x)-1 : _ppoint(x,y,col)
        ...
        *pixel2=(colour)
        ...
        For x As Long=0 To w-1 : ppoint2(x,y,col) : Var v=.299*((col Shr 16)And 255)+.587*((col Shr 8)And 255)+.114*(col And 255)
